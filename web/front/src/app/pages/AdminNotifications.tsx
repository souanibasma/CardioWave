...
const MAIN_FONT = "'DM Sans', sans-serif";
...
.ring-1 { animation:expandRing 4s ease-out infinite 0s; }
.ring-2 { animation:expandRing 4s ease-out infinite 1.3s; }
.ring-3 { animation:expandRing 4s ease-out infinite 2.6s; }
...
hero: {
  ...
  scrollMarginTop: 90, // 👈 corrige le clic Accueil
},
