    ...
    <div style={s.root}>
      ...
      <div style={s.centerWrap}>
        <div className="fade-up" style={s.header}>
          <h1 style={s.title}>Créez votre compte médecin</h1>

          <p style={s.subtitle}>
            Rejoignez CardioWave et accédez à l’analyse ECG propulsée par l’IA.
          </p>
        </div>
       ...
       <div
  className="fade-up"
  style={step === 1 ? s.cardInfo : s.cardSecurity}
>
...
`;
/* REMPLACE SEULEMENT CETTE PARTIE DANS const s */
