    ...
    <div className="min-h-screen w-full bg-[#f5f7ff] flex overflow-hidden">
      ...
      >
        ...
        <div className="px-4 pt-5 pb-3 flex items-center gap-4">
          ...
          <div className="min-w-[54px] min-h-[54px] rounded-[20px] bg-gradient-to-br from-blue-500 to-indigo-700 flex items-center justify-center shadow-xl">
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100">
        ...
        <div className="flex items-center justify-between px-4 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-700 flex items-center justify-center">
